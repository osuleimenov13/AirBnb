        ...
        VStack {
            ...
            VStack(alignment: .leading) {
                if selectedOption == .location {
                    ...
                    SearchBarComponent(title: "Where", description: "Add destination")
                }
            }
            .modifier(SearchBarComponentViewModifier())
            ...
            VStack {
                if selectedOption == .guests {
                    ...
                    SearchBarComponent(title: "Who", description: "Add guests")
                }
            }
            .modifier(SearchBarComponentViewModifier())
...
struct SearchBarComponentViewModifier: ViewModifier {
